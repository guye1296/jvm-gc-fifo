...
\begin{document}
 ...
 \begin{itemize}
   ...
   \item \texttt{./hotspot/make/linux/makefiles/buildtree.make} - Generator of different targets required. Generated the Makefile for the Parallel Scavenge implementation.
 ...
 \begin{itemize}
   ...
   \item \textbf{SPECjvm2008} we chose \textit{transform.xml}
 \end{itemize}
